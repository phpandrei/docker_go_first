...
func main() {
    ...
    //если не передать cancel (закомментить), то сообщения "Canceled: ХХХ" не выведутся
    //Canceling order processing!
    cancel()
    ...
    //передадим, когда все медленные процессы выполнились и тогда Canceled: ХХХ" не выведутся. так как обхявили cancel
